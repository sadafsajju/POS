-- Update initial_setup to also auto-confirm the user's email
-- This allows signIn immediately after setup without email confirmation
...
BEGIN
    ...
    -- 5. Auto-confirm email + update app_metadata for JWT hook
