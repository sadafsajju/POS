-- Allow anon to call initial_setup (needed when email confirmation is enabled)
-- The function is SECURITY DEFINER so it runs as the owner.
-- Add guard: only works when no admin exists yet.
