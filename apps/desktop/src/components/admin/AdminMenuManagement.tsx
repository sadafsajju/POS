...
export function AdminMenuManagement() {
  ...
  const handleCategoryCancelForm = () => {
    setShowCreateCategoryForm(false)
    setEditingCategory(null)
  }
    ...
    return (
      <div className="h-full overflow-auto p-6">
        <CategoryForm
          ...
          onCancel={handleCategoryCancelForm}
        />
      </div>
    )
  }
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      {/* Tabs */}
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as ActiveTab)} className="flex-1 flex flex-col min-h-0 px-6">
        ...
        {/* Products Tab */}
        <TabsContent value="products" className="flex-1 overflow-auto mt-0 pb-6 space-y-6">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between gap-4">
                ...
                <Button onClick={() => navigate({ to: '/admin/settings/menu/new' })} className="gap-2">
          ...
          <div className="space-y-4">
            {displayMode === 'table' ? (
              <AdminMenuTable
                ...
                onEdit={(product: Product) => navigate({ to: '/admin/settings/menu/$productId/edit', params: { productId: product.id.toString() } })}
                      ...
                      <div className="flex items-start justify-between">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {product.dietary_type && (
                                <DietaryIndicator type={product.dietary_type} size="sm" showLabel />
                              )}
                            </div>
                          </div>
                        </div>
                        <div className="flex flex-col space-y-1 ml-2">
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => navigate({ to: '/admin/settings/menu/$productId/edit', params: { productId: product.id.toString() } })}
        ...
        {/* Categories Tab */}
        <TabsContent value="categories" className="flex-1 overflow-auto mt-0 pb-6 space-y-6">
