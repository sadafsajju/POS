    ...
    <div className="h-full flex flex-col bg-background select-none">
      ...
      {(errorMessage || successMessage) && (
        <div className="flex-shrink-0 px-4 pt-3">
          {errorMessage && (
            <div className="p-4 bg-destructive/10 text-destructive rounded-lg flex items-center gap-3 text-base">
              <AlertCircle className="w-5 h-5" />
              {errorMessage}
            </div>
          )}
          {successMessage && (
            <div className="p-4 bg-green-100 text-green-800 rounded-lg text-base">
              {successMessage}
            </div>
          )}
        </div>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-5 py-4">
            <div className="space-y-2">
              <Label htmlFor="edit-phone" className="text-base">Phone Number</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-email" className="text-base">Email (optional)</Label>
              <div className="relative">
          ...
          <DialogFooter className="gap-3 sm:gap-3">
            <Button variant="outline" className="h-12 text-base px-6" onClick={() => setEditDialogOpen(false)}>Cancel</Button>
            <Button className="h-12 text-base px-6" onClick={handleSaveEdit} disabled={isSaving}>
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-5 py-4">
            <div className="space-y-2">
              <Label htmlFor="create-phone" className="text-base">Phone Number *</Label>
              <div className="relative">
                <Phone className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                <Input
                  id="create-phone"
            ...
            <div className="space-y-2">
              <Label htmlFor="create-name" className="text-base">Name</Label>
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                <Input
                  id="create-name"
            ...
            <div className="space-y-2">
              <Label htmlFor="create-email" className="text-base">Email (optional)</Label>
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                <Input
                  id="create-email"
            ...
            {createError && <p className="text-base text-red-500">{createError}</p>}
          </div>
          <DialogFooter className="gap-3 sm:gap-3">
            <Button variant="outline" className="h-12 text-base px-6" onClick={() => setCreateDialogOpen(false)}>Cancel</Button>
            <Button className="h-12 text-base px-6" onClick={handleCreate} disabled={isCreating}>
      ...
      <div className="p-4 border-b border-border space-y-3 bg-muted/30">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-medium">{totalCount} customer{totalCount !== 1 ? 's' : ''}</span>
          </div>
          <Button size="lg" className="h-11 text-sm px-5" onClick={onAddCustomer}>
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-48 text-muted-foreground">
            <Users className="w-14 h-14 mb-3 opacity-50" />
          ...
          <div className="divide-y divide-border">
            {customers.map(customer => {
              ...
              return (
                <div
                  key={customer.id}
                  className={`px-5 py-4 cursor-pointer transition-colors active:bg-muted/70 hover:bg-muted/50 ${
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mt-1.5 text-sm text-muted-foreground ml-[52px]">
    ...
    return (
      <div className="flex-1 flex items-center justify-center text-muted-foreground">
        <div className="text-center p-8">
          ...
          <p className="text-xl font-medium">Select a Customer</p>
          <p className="text-base mt-2">Tap on a customer to view details</p>
        </div>
      </div>
    )
  }
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-5 border-b border-border">
        <div className="flex items-center justify-between mb-3">
          ...
          <Button variant="outline" className="h-11 text-sm px-4" onClick={(e) => onEditCustomer(customer, e)}>
        ...
        <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-border">
          ...
          <div className="text-center py-2">
            ...
            <p className="text-base font-bold">{formatDate(customer.last_order_at)}</p>
          </div>
        </div>
      </div>
      ...
      {ordersTotalPages > 1 && (
        <div className="flex items-center justify-between px-5 py-3 border-t border-border">
          <span className="text-sm text-muted-foreground">Page {ordersPage} of {ordersTotalPages}</span>
          <div className="flex gap-2">
            <Button
              variant="outline"
              size="lg"
