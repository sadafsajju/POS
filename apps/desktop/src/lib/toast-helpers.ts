...
export const toastHelpers = {
  ...
  paymentProcessed: (amount?: number, currencySymbol: string = '$') => {
    return toastHelpers.success(
      "Payment Processed",
      amount ? `Payment of ${currencySymbol}${amount.toFixed(2)} processed successfully.` : "Payment processed successfully."
    )
  },
